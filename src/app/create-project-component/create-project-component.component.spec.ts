...
describe('Add-Project-Component-Testing the add-project', () => {
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        declarations: [CreateProjectComponentComponent, FilterPipe, ModalComponent, ProjectListComponentComponent],
        imports:[
          ReactiveFormsModule,
